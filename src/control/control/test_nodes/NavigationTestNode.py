...
class NavigationTestNode(Node):
    def __init__(self):
        ...
        self.steering = Dispatcher().get_steering_strategy()
        ...
        self.timer = self.create_timer(0.1, self.testNavigation)
    ...
    def testNavigation(self):
        if self.x_axis is not None and self.z_axis is not None:
            ...
            self.steering.steer(self.motors)
...
def main(args=None):
    ...
    try:
        ...
        navigation_test_node._logger.info(f"NavigationTestNode stopped: {e}")
